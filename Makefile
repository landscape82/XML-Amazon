# This Makefile is for the XML::Amazon extension to perl.
#
...
#     ABSTRACT => q[Perl extension for getting information from Amazon]
#     AUTHOR => q[Yusuke Sugiyama, <ally@blinkingstar.net>]
#     BUILD_REQUIRES => {  }
#     DIR => []
#     DISTNAME => q[XML-Amazon]
#     NAME => q[XML::Amazon]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { URI::Escape=>q[0], POSIX=>q[0], ExtUtils::MakeMaker=>q[6.55_02], Data::Dumper=>q[0], Digest::SHA=>q[0], XML::Simple=>q[0], LWP::Simple=>q[0] }
#     VERSION => q[0.12a]
#     dist => {  }
...
TO_INST_PM = lib/XML/Amazon.pm \
	lib/XML/Amazon/Collection.pm \
	lib/XML/Amazon/Item.pm

PM_TO_BLIB = lib/XML/Amazon/Item.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/XML/Amazon.pm $(INST_MAN3DIR)/XML::Amazon.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.12a">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for getting information from Amazon</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Yusuke Sugiyama, &lt;ally@blinkingstar.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/XML/Amazon/Item.pm blib/lib/XML/Amazon/Item.pm \
	  lib/XML/Amazon/Collection.pm blib/lib/XML/Amazon/Collection.pm \
	  lib/XML/Amazon.pm blib/lib/XML/Amazon.pm 
